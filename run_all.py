...
SCRIPTS = [
    ...
    ("Asia event study", "src/analysis/asia_event_study.py"),
    ("Japan follow-on event study", "src/analysis/japan_follow_on_event_study.py"),
    ("Asia follow-on event study", "src/analysis/asia_follow_on_event_study.py"),
    ("Korea Asia event study", "src/analysis/korea_asia_event_study.py"),
    ("Korea Asia event study robustness", "src/analysis/korea_asia_event_study_robustness.py"),
