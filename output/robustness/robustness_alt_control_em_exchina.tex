\begin{table}
\caption{Panel OLS Robustness - EM EXCHINA Control Group}
\label{tab:robust_alt_em_exchina}
\begin{tabular}{llll}
\toprule
...
Stewardship x Japan &  &  & 0.05 (0.04) \\
Corporate Governance Code x Japan &  &  & -0.32 (0.04) \\
TSE P/B Reform x Japan &  &  & -0.29 (0.12) \\
